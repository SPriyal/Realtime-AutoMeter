...
(function () {
    ...
    function V(a, b, c) {
        var d, e;
        if (Ja(b))u(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (u(b) && ia(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    var r, C = document, S = window, X = Math, v = X.round, W = X.floor, za = X.ceil, x = X.max, B = X.min, Q = X.abs, ba = X.cos, ga = X.sin, va = X.PI, ra = va * 2 / 360, Ha = navigator.userAgent, Ub = S.opera, Ea = /(msie|trident)/i.test(Ha) && !Ub, nb = C.documentMode === 8, ob = /AppleWebKit/.test(Ha), Va = /Firefox/.test(Ha), fb = /(Mobile|Android|Windows Phone)/.test(Ha), Ia = "http://www.w3.org/2000/svg", ea = !!C.createElementNS && !!C.createElementNS(Ia,
            "svg").createSVGRect, Zb = Va && parseInt(Ha.split("Firefox/")[1], 10) < 4, ma = !ea && !Ea && !!C.createElement("canvas").getContext, Wa, $a, Vb = {}, Ib = 0, lb, P, ka, Ga, Jb, I, ha = function () {
        return r
    }, ca = [], gb = 0, Ua = "div", Z = "none", $b = /^[0-9]+$/, pb = ["plotTop", "marginRight", "marginBottom", "plotLeft"], ac = "stroke-width", fa, mb, wb, kb, Ab, Bb, Cb, cb, db, eb, Pb, Qb, Rb, Sb, Db, Eb, Fb, G = {}, A;
    ...
    ka = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new fa(b - bb(b)), e, f = d[Bb](), g = d[Cb](), h = d[cb](), i = d[db](), k = d[eb](), j = P.lang, m = j.weekdays, d = w({
            a: m[g].substr(0, 3),
            A: m[g],
            d: Ra(h),
            e: h,
    ...
    A.numberFormat = function (a, b, c, d) {
        var e = P.lang, a = +a || 0, f = b === -1 ? B((a.toString().split(".")[1] || "").length, 20) : isNaN(b =
            Q(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(L(a = Q(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    N && N.init.call(N, Jb);
    var qb = H.adapterRun, bc = H.getScript, Oa = H.inArray, n = A.each = H.each, hb = H.grep, cc = H.offset, Aa = H.map, D = H.addEvent, T = H.removeEvent, F = H.fireEvent, dc = H.washMouseEvent,
    ...
    Ob();
    var ec = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, fc = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, gc = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/,
        wa = function (a) {
            var b = [], c, d;
            (function (a) {
    ...
    Y.prototype = {
        ...
        colorGradient: function (a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && l && !u(g.gradientUnits) && (g = z(g, {
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (Ea && !ea)M(this.element, a); else {
                    b = function (a, b) {
            ...
            if (!b) {
                if (f.namespaceURI ===
                    ...
                    try {
                        ...
                        }, Va && k.textShadow ? (i = k.textShadow, k.textShadow = "") : j && j(Z), b = f.getBBox ? w({}, f.getBBox()) : {
                            width: f.offsetWidth,
                ...
                if (c.isSVG) {
                    ...
                    if (e)b.width = Q(d * ga(h)) + Q(a * ba(h)), b.height =
                        Q(d * ba(h)) + Q(a * ga(h))
                }
                c.cache[m] = b
            }
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)if (e = d[i], f = V(e, "zIndex"), e !== g && (L(f) > a || !u(a) && u(f)))c.insertBefore(g,
                    e), h = !0;
                h || c.appendChild(g)
            }
            return h
    ...
    Y.prototype["stroke-widthSetter"] = Y.prototype.strokeSetter = function (a, b, c) {
        ...
        if (this.stroke && this["stroke-width"])this.strokeWidth = this["stroke-width"],
            Y.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (b === "stroke-width" && a === 0 && this.hasStroke)c.removeAttribute("stroke"), this.hasStroke = !1
    };
    var na = function () {
    ...
    na.prototype = {
        Element: Y, init: function (a, b, c, d, e) {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = V(b, "x"), j = a.styles, m = a.textWidth, l = j && j.lineHeight, o = j && j.textShadow, q = j && j.textOverflow === "ellipsis", s = g.length, E = m && !a.added && this.box, $ = function (a) {
            ...
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, E && E.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), n(e, function (e, f) {
                var g,
                    l = 0, e = e.replace(/<span/g, "|||<span").replace(/<\/span>/g, "</span>|||");
                g = e.split("|||");
                n(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            if (m) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || o.length > 1 && j.whiteSpace !== "nowrap", n, y, r, u = [], v = $(s), x = 1, w = a.rotation, z = e, B = z.length; (p || q) && (o.length || u.length);)a.rotation = 0, n = a.getBBox(!0), r = n.width, !ea && c.forExport && (r = c.measureSpanWidth(s.firstChild.data, a.styles)), n = r > m, y === void 0 && (y = n), q && y ? (B /= 2, z === "" || !n && B < 0.5 ? o = [] : (n && (y = !0), z = e.substring(0, z.length + (n ? -1 : 1) * za(B)), o = [z + (m > 3 ? "…" : "")], s.removeChild(s.firstChild))) :
                                    !n || o.length === 1 ? (o = u, u = [], o.length && (x++, s = C.createElementNS(Ia, "tspan"), V(s, {
                                        dy: v,
                                        x: k
                                    }), E && V(s, "style", E), b.appendChild(s)), r > m && (m = r)) : (s.removeChild(s.firstChild), u.unshift(o.pop())), o.length && s.appendChild(C.createTextNode(o.join(" ").replace(/- /g, "-")));
            ...
            var k =
                this.label(a, b, c, i, null, null, null, null, "button"), j = 0, m, l, o, q, s, E, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            E = h.style;
            delete h.style;
            D(k.element, Ea ? "mouseover" : "mouseenter", function () {
                j !== 3 && k.attr(f).css(q)
            });
            D(k.element, Ea ? "mouseout" : "mouseleave", function () {
                j !== 3 && (m = [e, f, g][j], l = [o, q, s][j], k.attr(m).css(l))
            });
            k.setState = function (a) {
                (k.state = j = a) ? a === 2 ? k.attr(g).css(s) : a === 3 && k.attr(h).css(E) : k.attr(e).css(o)
            };
            ...
            var e = ia(a) ? a.r :
                e, g = this.createElement("rect"), a = ia(a) ? a : a === r ? {} : {
                x: a,
                y: b,
                width: x(c, 0),
                height: x(d, 0)
            ...
            }, k = a.match(i)[1], a = Vb[k] || f && f.width && f.height && [f.width, f.height], g = this.image(k).attr({
                x: b,
                y: c
            }), g.isImg = !0, a ? j(g, a) : (g.attr({width: 0, height: 0}), aa("img", {
                onload: function () {
                    j(g, Vb[k] = [this.width, this.height])
                }, src: k
            }));
            return g
        }, symbols: {
            circle: function (a, b, c, d) {
                ...
                var f = B(e && e.r || 0, c, d), g =
                    f + 6, h = e && e.anchorX, e = e && e.anchorY, i;
            ...
            return w(o, {
                css: function (a) {
                    ...
                    return {width: E.width + 2 * t, height: E.height + 2 * t, x: E.x - t, y: E.y - t}
                }, shadow: function (a) {
                    s && s.shadow(a);
                    return o
                }, destroy: function () {
        ...
        htmlCss: function (a) {
            ...
            if (this.added) {
                var a = this.renderer, b = this.element, c = this.translateX || 0,
                    d = this.translateY || 0, e = this.x || 0, f = this.y || 0, g = this.textAlign || "left", h = {
                        left: 0,
                        center: 0.5,
                        right: 1
    ...
    if (!ea && !ma)H = {
        ...
        add: function (a) {
            ...
            for (var b = a.length, c = []; b--;)if (sa(a[b]))c[b] = v(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b +
        ...
        Element: H, isIE8: Ha.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
        ...
        isHidden: function () {
            ...
            if (i) {
                var j, m, l = a.linearGradient || a.radialGradient, o, q, s, E, p, t = "", a = a.stops, y, oa = [], r = function () {
                ...
                if (c === "fill")if (i === "gradient")c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, t = 'angle="' + (90 - X.atan((l - a) / (o - c)) * 180 / va) + '"', r(); else {
                    var k = l.r, u = k * 2, x = k * 2, v = l.cx, w = l.cy, z = b.radialReference, B, k = function () {
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = wa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), k = f.get("rgb"); else {
        ...
        A.VMLRenderer = ib = function () {
            this.init.apply(this, arguments)
        }, ib.prototype = z(na.prototype, H), Wa = ib;
    ...
    var Wb;
    if (ma)A.CanVGRenderer = H = function () {
    ...
    Za.prototype = {
        addLabel: function () {
            ...
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, B(b.pos, e[3])), e = p(b.labelRight, x(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
                left: 0,
                center: 0.5,
                right: 1
            }[b.labelAlign], k = g.getBBox().width, j = b.slotWidth, m = 1, l, o =
            {};
            if (h)h < 0 && c - i * k < f ? l = v(c / ba(h * ra) - f) : h > 0 && c + i * k > e && (l = v((d - c) / ba(h * ra))); else if (d = c + (1 - i) * k, c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i, m = -1), j = B(b.slotWidth, j), j < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - j - i * (b.slotWidth - B(k, j)))), k > j || b.autoRotation && g.styles.width)l = j;
            if (l) {
                o.width = l;
            ...
            if (l && n)y === "inside" && (n = -n), d.opposite && (n = -n), h = this.getMarkPath(w, v, n, l * z, g, f), o ? o.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: t, "stroke-width": l, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(w))i.xy = v = this.getLabelPosition(w,
    ...
    A.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz,
                d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, k = u(i) && u(h), j = d.value, m = d.dashStyle, l = a.svgElem, o = [], q, s = d.color, E = d.zIndex, n = d.events, t = {}, p = b.chart.renderer;
    ...
    J.prototype = {
        ...
        setOptions: function (a) {
            this.options = z(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions,
                this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], z(P[this.coll], a))
        },
        defaultLabelFormatter: function () {
            ...
            if (h)g = Ma(h, this); else if (c)g = b; else if (d)g = ka(d, b); else if (f && a >= 1E3)for (; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = A.numberFormat(b / c, -1) + e[f]);
            g === r && (g = Q(b) >=
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            ...
            var o = function (a, b, c) {
                if (a < b || a > c)d ? a = B(x(b, a),
                    c) : l = !0;
                return a
            }, e = p(e, this.translate(a, null, null, c)), a = c = v(e + i);
            i = k = v(j - e - i);
        ...
        getMinorTickPositions: function () {
            var a = this.options, b = this.tickPositions,
                c = this.minorTickInterval, d = [], e, f = this.min;
            e = this.max;
            var g = e - f;
        ...
        adjustForMinRange: function () {
            var a = this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange,
                f, g, h, i, k;
            if (this.isXAxis && this.minRange === r && !this.isLog)u(a.min) || u(a.max) ? this.minRange = null : (n(this.series, function (a) {
                i = a.xData;
        ...
        setAxisTranslation: function (a) {
            var b =
                this, c = b.max - b.min, d = b.axisPointRange || 0, e, f = 0, g = 0, h = b.linkedParent, i = !!b.categories, k = b.transA, j = b.isXAxis;
        ...
        setTickInterval: function (a) {
            ...
            if (!l && !b.axisPointRange && !b.usePercentage && !h && u(b.min) && u(b.max) && (c = b.max - b.min)) {
                if (!u(d.min) && !u(b.userMin) && k && (b.dataMin < 0 || !b.ignoreMinPadding))b.min -=
                    c * k;
        ...
        trimTicks: function (a, b, c) {
            var d = a[0],
                e = a[a.length - 1], f = this.minPointOffset || 0;
        ...
        renderUnsquish: function () {
            var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin, h = this.categories ? c.length : c.length - 1, i = this.slotWidth = f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / h || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), k = x(1, v(i - 2 * (e.padding || 5))), j = {},
                g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), h = e.style.textOverflow, m, l = 0;
        ...
        getOffset: function () {
            var a = this, b = a.chart,
                c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, k, j, m = 0, l, o = 0, q = d.title, s = d.labels, E = 0, $ = b.axisOffset, b = b.clipOffset, t = [-1, 1, 1, -1][h], y;
            k = a.hasData();
            a.showAxis = j = k || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && s.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: s.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() +
            "-labels").add();
            if (k || a.isLinked) {
                if (n(e, function (b) {
                        ...
                        if (h === 0 || h === 2 || {
                                1: "left",
                                3: "right"
                            }[h] === a.labelAlign)E = x(f[b].getLabelSize(), E)
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = e.x || 0, k = e.y || 0, j = L(e.style.fontSize || 12), d = {
                    low: f + (a ? 0 : d),
                    middle: f + d / 2,
                    high: f + (a ? d : 0)
                }[e.align],
        ...
        render: function () {
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (n(g, function (b, c) {
                        if (!f || b >= a.min && b <= a.max)i[b] || (i[b] = new Za(a, b)), E && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c)
                    }), o && (a.min === 0 || a.single)))i[-1] || (i[-1] = new Za(a, -1, null, !0)), i[-1].render(-1);
                l && n(g, function (b, c) {
                    if (c % 2 === 0 && b < a.max)j[b] || (j[b] = new A.PlotLineOrBand(a)), t = b + o, y = g[c + 1] !==
                    r ? g[c + 1] + o : a.max, j[b].options = {
                        from: e ? ta(t) : t,
                        to: e ? ta(y) : y,
                        color: l
            ...
            n([i, k, j], function (a) {
                var c, d, e = [], f = Ga ? Ga.duration || 500 : 0, g = function () {
            ...
            if (q)s = a.getLinePath(q), a.axisLine ? a.axisLine.animate({d: s}) : a.axisLine = c.path(s).attr({
                stroke: d.lineColor,
                "stroke-width": q,
                zIndex: 7
    ...
    w(J.prototype, {
        getPlotBandPath: function (a, b) {
            ...
            var c =
                (new A.PlotLineOrBand(this, a)).render(), d = this.userOptions;
    ...
    J.prototype.getTimeTicks = function (a, b, c, d) {
        var e = [], f = {}, g = P.global.useUTC, h, i = new fa(b - bb(b)),
            k = a.unitRange, j = a.count;
        if (u(b)) {
            ...
            h = i[eb]();
            for (var d = i.getTime(), m = i[db](), l =
                i[cb](), o = (I.day + (g ? bb(i) : i.getTimezoneOffset() * 6E4)) % I.day; d < c;)e.push(d), k === I.year ? d = mb(h + b * j, 0) : k === I.month ? d = mb(h, m + b * j) : !g && (k === I.day || k === I.week) ? d = mb(h, m, l + b * j * (k === I.day ? 1 : 7)) : d += k * j, b++;
            e.push(d);
            n(hb(e, function (a) {
                return k <= I.hour && a % I.day === o
            }), function (a) {
                f[a] = "day"
            })
        }
    ...
    J.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]],
                ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = I[d[0]], f = d[1], g;
    ...
    J.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = v(a), g = this.getLinearTickPositions(a,
            b, c); else if (a >= 0.08)for (var f = W(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
            i = e.length;
    ...
    Lb.prototype = {
        ...
        destroy: function () {
            ...
            var d = this.chart, e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop], k = ["x", d.chartWidth, a, c.plotX + d.plotLeft], j = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), m = function (a, b, c, d) {
                var h = c < d - e, i = d + e + c < b, k = d - e - c;
                d += e;
                if (j && i)f[a] = d; else if (!j && h)f[a] = k; else if (h)f[a] = k - g < 0 ? k : k - g; else if (i)f[a] =
                    d + g + c > b ? d : d + g; else return !1
            }, l = function (a, b, c, d) {
            ...
            k === !1 ? this.hide() : (this.isHidden && (ab(d), d.attr("opacity", 1).show()), d.attr({text: k}), m = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: m}), this.updatePosition({
                plotX: f,
                plotY: g,
                negative: a.negative,
                ttBelow: a.ttBelow,
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (A.Tooltip && b.tooltip.enabled)a.tooltip = new Lb(a, b.tooltip), this.followTouchMove =
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && m && !q && !this.selectionMarker)this.selectionMarker = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({
                ...
                if (this.hasDragged || d)n(c.axes, function (c) {
                    if (c.zoomEnabled && u(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                        var f = c.horiz, o = a.type === "touchend" ? c.minPixelPadding :
                            0, q = c.toValue((f ? g : h) + o), f = c.toValue((f ? g + i : h + k) - o);
                        e[c.coll].push({axis: c, min: B(q, f), max: x(q, f)});
                        j = !0
                    }
                }), j && F(c, "selection", e, function (a) {
            ...
            }, gb === 1 && D(C, "touchend", a.onDocumentTouchEnd)
        }, destroy: function () {
            var a;
    ...
    w(A.Pointer.prototype,
        {
            ...
            var i = this.chart, k = a ? "x" : "y", j = a ? "X" : "Y", m = "chart" + j, l = a ? "width" : "height", o = i["plot" + (a ? "Left" : "Top")], q, s, p = h || 1, n = i.inverted, t = i.bounds[a ? "h" : "v"], y = b.length === 1, r = b[0][m], v = c[0][m], u = !y && b[1][m], x = !y && c[1][m], w, c = function () {
            ...
            var b = this, c = b.chart, d = b.pinchDown, e = a.touches, f = e.length, g = b.lastValidTouch, h = b.hasZoom, i = b.selectionMarker, k = {}, j = f === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || b.runChartClick),
                m = {};
    ...
    if (S.PointerEvent || S.MSPointerEvent) {
        var Ba = {}, Mb = !!S.PointerEvent, hc = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
        ...
        w(Xa.prototype, {
            onContainerPointerDown: function (a) {
                Nb(a, "onContainerTouchStart", "touchstart", function (a) {
                    Ba[a.pointerId] = {pageX: a.pageX, pageY: a.pageY, target: a.currentTarget}
                })
    ...
    tb.prototype = {
        init: function (a, b) {
            ...
            this.options = b;
            if (b.enabled)c.itemStyle = d, c.itemHiddenStyle = z(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16),
                c.pages = [], c.render(), D(c.chart, "endResize", function () {
            ...
            if (!n) {
                ...
                a.legendItem = n = c.text("", m ? f + g : -g, this.baseline || 0, y).css(z(a.visible ? h : i)).attr({
                    align: m ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup);
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, k = e.navigation, j = p(k.animation, !0), m = k.arrowSize || 12, l = this.nav, o = this.pages, q = this.padding,
                s, E = this.allItems, $ = function (a) {
                    i.attr({height: a});
            ...
            var c = this.pages,
                d = c.length, e = this.currentPage + a, f = this.clipHeight, g = this.options.navigation, h = g.activeColor, g = g.inactiveColor, i = this.pager, k = this.padding;
            e > d && (e = d);
    ...
    Pa.prototype = {
        ...
        getStacks: function () {
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || qb(d, "width"), f = c.height || qb(d, "height"), c = a ? a.target : S, d = function () {
            ...
            var b =
                this.inverted, c = this.renderer, d = this.chartWidth, e = this.chartHeight, f = this.options.chart, g = this.spacing, h = this.clipOffset, i, k, j, m;
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground,
                f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, k = a.backgroundColor, j = a.plotBackgroundColor, m = a.plotBackgroundImage, l = a.plotBorderWidth || 0, o, q = this.plotLeft, s = this.plotTop, n = this.plotWidth, p = this.plotHeight, t = this.plotBox, y = this.clipRect, r = this.clipBox;
            o = i + (a.shadow ? 8 : 0);
            ...
            if (l)g ? g.animate(g.crisp({
                ...
                height: p,
                strokeWidth: -l
            })) : this.plotBorder = b.rect(q, s, n, p, 0, -l).attr({
            ...
            var a = this;
            return !ea && S == S.top && C.readyState !== "complete" || ma && !S.canvg ? (ma ? Wb.push(function () {
                a.firstRender()
    ...
    Ca.prototype = {
        init: function (a, b, c) {
            ...
            var b = {}, c = this.series, d = c.options.keys, e = d || c.pointArrayMap ||
                ["y"], f = e.length, g = 0, h = 0;
            ...
            var b = this.series,
                c = b.tooltipOptions, d = p(c.valueDecimals, ""), e = c.valuePrefix || "", f = c.valueSuffix || "";
    ...
    O.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)n(a, function (a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (sa(j)) {
                        ...
                        e.xIncrement = l
                    } else if (Ka(j))if (E)for (c = 0; c < h; c++)i = a[c], q[c] = i[0], s[c] = i.slice(1, E + 1); else for (c = 0; c < h; c++)i = a[c], q[c] = i[0], s[c] = i[1]; else qa(12)
                } else for (c = 0; c < h; c++)if (a[c] !== r && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i,
        ...
        processData: function (a) {
            ...
            if (h)a = h.getExtremes(), m = a.min,
                l = a.max;
            if (j && this.sorted && (!i || d > i || this.forceCrop))if (b[d - 1] < m || b[0] > l)b = [], c = []; else if (b[0] < m || b[d - 1] > l)e = this.cropData(this.xData, this.yData, m, l), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        generatePoints: function () {
            ...
            for (l = 0; l < g; l++)i = h + l, k ? m[l] = (new f).init(this, [d[l]].concat(pa(e[l]))) : (b[i] ? j = b[i] : a[i] !== r && (b[i] = j = (new f).init(this,
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (m = 0; m < d; m++)if (k = c[m], j = a[m], i = j !== null && j !== r && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped ||
                (c[m + 1] || k) >= g && (c[m - 1] || k) <= h, i && k)if (i = j.length)for (; i--;)j[i] !== null && (e[f++] = j[i]); else e[f++] = j;
            this.dataMin = Sa(e);
            this.dataMax = Fa(e)
        },
        translate: function () {
        ...
        drawPoints: function () {
            ...
            if (m.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = W(g.plotX), e = g.plotY, j = g.graphic, o = g.marker || {}, q = !!g.marker, a = $ && o.enabled === r ||
                o.enabled, s = g.isInside, a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(o.symbol, this.symbol), k = i.indexOf("url") === 0, j)j[s ? "show" : "hide"](!0).animate(w({
                x: d - h,
                y: e - h
        ...
        destroy: function () {
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(Ha),
                d, e = a.data || [], f, g, h;
            F(a, "destroy");
            T(a);
        ...
        drawGraph: function () {
            var a = this, b = this.options, c = [["graph",
                b.lineColor || this.color, b.dashStyle]], d = b.lineWidth, e = b.linecap !== "square", f = this.getGraphPath(), g = this.fillGraph && this.color || Z;
            n(this.zones, function (d, e) {
                c.push(["zoneGraph" + e, d.color || a.color, d.dashStyle || b.dashStyle])
            });
            n(c, function (c, i) {
                var k = c[0], j = a[k];
                if (j)ab(j), j.animate({d: f}); else if ((d || g) && f.length)j = {
                    stroke: c[1],
                    "stroke-width": d,
                    fill: g,
                    zIndex: 1
                }, c[2] ? j.dashstyle = c[2] : e && (j["stroke-linecap"] = j["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(f).attr(j).add(a.group).shadow(i < 2 &&
                b.shadow)
            })
        },
        applyZones: function () {
            ...
            if (d.length && (i || k))i && i.hide(), k && k.hide(), l = m.getExtremes(), n(d, function (d, n) {
    ...
    O.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ? f : 0, h = e.stack,
                e = e.stacking, i = this.stackKey, k = "-" + i, j = this.negStacks, m = this.yAxis, l = m.stacks, o = m.oldStacks, q, s, n, r, t, y;
            for (r = 0; r < d; r++) {
                t = a[r];
                y = b[r];
                n = this.index + "," + r;
    ...
    w(Pa.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!d)b.loadingDiv = d = aa(Ua, {className: "highcharts-loading"},
                w(e.style, {
                    zIndex: 10,
                    display: Z
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                n(d, function (b) {
                    ...
                    if (!m || h[b] && h[b].y !== null)if (h[b])c.push(h[b]); else {
                        for (l = a.index; l <= f.series.length; l++)if (j = g[b].points[l + "," + b]) {
                            d = j[1];
                            break
                        }
                        i = e.translate(b);
    ...
    Da = ja(O, {
        ...
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis,
                f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, k = a.barW = x(i, 1 + 2 * d), j = a.pointXOffset = h.offset, m = -(d % 2 ? 0.5 : 0), l = d % 2 ? 0.5 : 1;
        ...
        drawPoints: function () {
            ...
            n(a.points, function (h) {
                ...
                if (i !== r && !isNaN(i) && h.y !==
                    null)f = h.shapeArgs, i = u(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], k ? (ab(k), k.attr(i)[b.pointCount < e ? "animate" : "attr"](z(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (k)h.graphic = k.destroy()
            })
        },
        animate: function (a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            if (ea)a ? (e.scaleY = 0.001, a = B(b.pos + b.len, x(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len :
    ...
    N = {
        ...
        translate: function (a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, k = this.startAngleRad = va / 180 * (i - 90), i = (this.endAngleRad = va / 180 * (p(c.endAngle, i + 360) - 90)) - k, j = this.points, m = c.dataLabels.distance, c = c.ignoreHiddenPoint, l,
                o = j.length, q;
    ...
    O.prototype.drawDataLabels = function () {
        var a =
            this, b = a.options, c = b.cursor, d = b.dataLabels, e = a.points, f, g, h = a.hasRendered || 0, i, k, j = a.chart.renderer;
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (k.attr({opacity: +h}), h || D(a, "afterAnimate", function () {
            a.visible && k.show();
            ...
            if (o && !h)e.dataLabel = o.destroy(); else if (h) {
                ...
                if (o)if (u(i))o.attr({text: i}), v = !1; else {
    ...
    O.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), k = b.getBBox(), j = f.renderer.fontMetrics(c.style.fontSize).b, m = this.visible && (a.series.forceDL || f.isInsidePlot(h,
        ...
        }).attr({align: c.align})) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (m = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)), c.shape &&
    ...
    if (G.pie)G.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, k, j, m = p(e.softConnector, !0), l = e.distance, o = a.center, q = o[2] / 2, s = o[1], r = l > 0, u, t, y, w = [[], []], z, A, D, C, K, G = [0, 0, 0, 0], L = function (a, b) {
            return b.y - a.y
        };
                ...
                if (J) {
                    ...
                    if (l > 0) {
                        ...
                        for (K = 0; K < J; K++) {
                            ...
                            if (F < K && H[K] !== null)F = K; else for (t < J - K + F && H[K] !== null && (F = t - J + K); H[F] ===
                            null;)F++;
                            M.push({i: F, y: H[F]});
                            H[F] = null
                        }
                    ...
                    for (K = 0; K < J; K++) {
                        ...
                        u.connX = z;
                        u.connY = A;
                        if (this.options.size === null)t = u.width, z - t < f ? G[3] = x(v(t - z + f), G[3]) : z + t > h -
                        f && (G[1] = x(v(z + t - h + f), G[1])), A - b / 2 < 0 ? G[0] = x(v(-A + b / 2), G[0]) : A + b / 2 > i && (G[2] = x(v(A + b / 2 - i), G[2]))
                    }
                }
            }
            if (Fa(G) === 0 || this.verifyDataLabelOverflow(G))this.placeDataLabels(), r && g && n(this.points, function (b) {
                k = b.connector;
                y = b.labelPos;
                if ((u = b.dataLabel) && u._pos && b.visible)D = u._attr.visibility, z = u.connX, A = u.connY, j = m ? ["M", z + (y[6] === "left" ? 5 : -5), A, "C", z, A, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", z + (y[6] === "left" ? 5 : -5), A, "L", y[2], y[3], "L", y[4], y[5]], k ? (k.animate({d: j}), k.attr("visibility", D)) : b.connector =
                    k = a.chart.renderer.path(j).attr({
                        "stroke-width": g,
    ...
    if (G.column)G.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f =
            this.chart.inverted, g = a.series, h = a.dlBox || a.shapeArgs, i = p(a.below, a.plotY > p(this.translatedThreshold, g.yAxis.len)), k = p(c.inside, !!this.options.stacking);
        if (h && (d = z(h), f && (d = {
    ...
    var jb = A.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            if (e && !c)for (l = e + 1; l--;)d[l] === "M" && d.splice(l + 1, 0, d[l + 1] - i, d[l + 2], "L"), (l && d[l] ===
    ...
    if (G.column)Da.prototype.drawTracker =
        jb.drawTrackerPoint;
    ...
    (function (a) {
        ...
        d(a.seriesTypes.column.prototype, "drawPoints", function (a) {
            a.apply(this);
            var a = this.points, b = this.yAxis, c = b.breakArray || [], d, e, g, h,
                n;
    ...
    var da = O.prototype, N = Lb.prototype, jc = da.processData, kc = da.generatePoints, lc = da.destroy, mc = N.tooltipFooterHeaderFormatter, nc = {
    ...
    }, Yb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], Qa = {
        sum: function (a) {
            var b = a.length, c;
            ...
            return a.length ? Fa(a) : a.hasNulls ? null : r
        }, low: function (a) {
    ...
    da.groupData = function (a,
        ...
        for (; s <= i; s++) {
            ...
            if (o) {
                ...
                var p;
                for (j = 0; j < n; j++)if (p = k[o[j]],
                    typeof p === "number")l[j].push(p); else if (p === null)l[j].hasNulls = !0
            } else if (k = m ? b[s] : null, typeof k === "number")l[0].push(k); else if (k === null)l[0].hasNulls = !0
        }
        return [g, h]
    };
    da.processData = function () {
        ...
        if (jc.apply(this, arguments) !== !1 && d) {
            ...
            var f = this.processedXData, g = this.processedYData, h = a.plotSizeX, a = this.xAxis,
                i = a.options.ordinal, k = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth(), d = this.pointRange;
            if (k) {
                e = !0;
                this.points = null;
    ...
    N = ja(G.column, {
        type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], toYData: function (a) {
            ...
            n(a.points, function (j) {
                if (j.plotY !== r)i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, k = v(j.plotX) - f, g = v(j.shapeArgs.width / 2), h = ["M", k, v(j.yBottom), "L", k, v(j.plotY)], j.open !== null && (d = v(j.plotOpen) + f, h.push("M", k, d, "L", k - g, d)), j.close !== null && (e = v(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)), i ? i.attr(c).animate({d: h}) :
    ...
    N = ja(N, {
        ...
        drawPoints: function () {
            ...
            n(a.points, function (n) {
                l = n.graphic;
                if (n.plotY !== r)c = n.pointAttr[n.selected ? "selected" : ""] || d, j = c["stroke-width"] % 2 / 2, m = v(n.plotX) - j, e = n.plotOpen, f = n.plotClose, g = X.min(e, f), h = X.max(e, f), q = v(n.shapeArgs.width /
    ...
    G.flags = ja(G.column, {
        ...
        translate: function () {
            ...
            n(b, function (c, d) {
                var f;
                if (c.plotY === r)c.x >= k.min && c.x <= k.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ? i.height : 0) + i.offset - a.plotTop :
                    c.shapeArgs = {};
        ...
        drawPoints: function () {
            ...
            for (k = c.length; k--;)if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX - p(j.lineWidth, g.lineWidth) % 2, m = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== r && (f = j.plotY + h - (m !== r && m * g.stackDistance)), l = m ? r : j.plotX, o = m ? r : j.plotY, m = j.graphic, f !== r && e >= 0 && !a)a = j.pointAttr[j.selected ?
                "select" : ""] || b, m ? m.attr({
                x: e,
                y: f,
                r: a.r,
                anchorX: l,
                anchorY: o
            }) : j.graphic = d.label(j.options.title || g.title || "A", e, f, i, l, o, g.useHTML).css(z(g.style, j.style)).attr(a).attr({
    ...
    w(P, {
        navigator: {
            ...
            yAxis: {
                gridLineWidth: 0, startOnTick: !1, endOnTick: !1, minPadding: 0.1, maxPadding: 0.1,
                labels: {enabled: !1}, crosshair: !1, title: {text: null}, tickWidth: 0
            }
        },
        scrollbar: {
            height: fb ? 20 : 14,
    ...
    Gb.prototype = {
        drawHandle: function (a, b) {
            var c = this.chart, d = c.renderer, e =
                this.elementsToDestroy, f = this.handles, g = this.navigatorOptions.handles, g = {
            ...
            f[b][c.isResizing ? "animate" : "attr"]({
                translateX: this.scrollerLeft + this.scrollbarHeight + parseInt(a, 10), translateY: this.top +
                this.height / 2 - 8
            })
            ...
            if (u(a) && !isNaN(a)) {
                ...
                if (!(m.translate(d, !0) - m.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    a = c - b;
                    if (!this.rendered) {
                        if (A)this.navigatorGroup = m = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().attr({fill: r.maskFill}).add(m), r.maskInside ? this.leftShade.css({cursor: "ew-resize "}) : this.rightShade = f.rect().attr({fill: r.maskFill}).add(m), this.outline = f.path().attr({
                            "stroke-width": D,
                            stroke: r.outlineColor
                        }).add(m);
                        if (s)this.scrollbarGroup = j = f.g("scrollbar").add(), l = w.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                            x: 0,
                            y: -l % 2 / 2,
                    ...
                    if (A) {
                        this.leftShade[e](r.maskInside ? {x: g + b, y: z, width: c - b, height: y} : {
                            x: g,
                            y: z,
                            width: b,
                            height: y
                    ...
                    if (s && j)this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({
                        translateX: i,
                        translateY: v(F + y)
                    }), o[e]({width: k}), g = n + b, h = a - H, h < t && (G = (t - h) / 2, h = t, g -= G), this.scrollbarPad = G, l[e]({
                        x: W(g) + H % 2 / 2,
                        width: h
                    }), t = n + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({
                        d: ["M",
            ...
            a.mouseDownHandler = function (d) {
                ...
                if (v > h && v < h + g + j)if ((h =
                        !a.scrollbarEnabled || v < h + g) && X.abs(u - e - m) < w)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && X.abs(u - f - m) < w)a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null; else if (u > m + e - p && u < m + f + p)a.grabbedCenter = u, a.fixedWidth = r, i = u - e; else if (u > k && u < k + l) {
                    f = h ? u - m - r / 2 : u < m ? e - r * 0.2 : u > k + l - j ? e + r * 0.2 : u < m + e ? e - r : f;
                    if (f < 0)f = 0; else if (f + r >= n)f = n - r, x = a.getUnionExtremes().dataMax;
                    if (f !== e)a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, x), d.setExtremes(e.min, e.max,
    ...
    R(J.prototype, "zoom", function (a, b, c) {
        ...
        if (this.isXAxis && (g && g.enabled || e && e.enabled))if (f === "x")d.resetZoomButton = "blocked"; else if (f === "y")h = !1; else if (f === "xy")d = this.previousZoom, u(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
    ...
    Hb.prototype = {
        clickButton: function (a, b) {
            var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, k = i.dataMin, j = i.dataMax, m, l = h && v(B(h.max, p(j, h.max))), o = new fa(l), q = g.type, s = g.count,
                u, i = g._range, w, t, y, z = g.dataGrouping;
            if (!(k === null || j === null || a === c.selected)) {
                if (z)this.forcedDataGrouping = !0, J.prototype.setDataGrouping.call(h || {chart: this.chart}, z, !1);
                if (q === "month" || q === "year")m = {
                    month: "Month",
                    year: "FullYear"
                }[q], o["set" + m](o["get" + m]() - s), m = o.getTime(), k = p(k, Number.MIN_VALUE), isNaN(m) || m < k ? (m = k, l = B(m + i, j)) : i = l - m; else if (i)m = x(l - i, k), l = B(m + i, j); else if (q === "ytd")if (h) {
                    if (j === r)k = Number.MAX_VALUE, j = Number.MIN_VALUE, n(e.series, function (a) {
                        a = a.xData;
                        k = B(a[0], k);
                        j = x(a[a.length - 1],
                            j)
                ...
                }), c.setSelected(a)) : (u = e.options.xAxis[0], y = u.range, u.range = i, t = u.min, u.min = w, c.setSelected(a), D(e, "load", function () {
                    u.range = y;
                    u.min = t
                }))
            }
        ...
        updateButtonStates: function (a) {
            var b = this, c = this.chart, d = c.xAxis[0], e = c.scroller && c.scroller.getUnionExtremes() ||
                d, f = e.dataMin, g = e.dataMax, h = b.selected, i = b.options.allButtonsEnabled, k = b.buttons;
        ...
        computeButtonRange: function (a) {
            var b = a.type, c =
                a.count || 1, d = {millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5};
        ...
        drawInput: function (a) {
            ...
            this[a + "DateBox"] = e = e.label("", j.offset).attr({
                ...
                "stroke-width": 1
            }).css(z({textAlign: "center", color: "#444"}, d, f.inputStyle)).on("click", function () {
                b.showInput(a);
                b[a + "Input"].focus()
            }).add(j);
        ...
        render: function (a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, k = c.buttons, g = P.lang, j = c.div, j = c.inputGroup, m = i.buttonTheme, l = i.buttonPosition || {}, o = i.inputEnabled,
                q = m && m.states, s = d.plotLeft, r, v = this.getPosition(), t = c.group;
            if (!c.rendered && (c.group = t = e.g("range-selector-buttons").add(), c.zoomText = e.text(g.rangeSelectorZoom, p(l.x, s), v.buttonTop + 15).css(i.labelStyle).add(t), r = p(l.x, s) + c.zoomText.getBBox().width + 5, n(c.buttonOptions, function (a, b) {
                    ...
                    c.updateButtonStates(), o !== !1))c.div = j = aa("div", null, {
                position: "relative",
                height: 0,
                zIndex: 1
            ...
            }, i.inputPosition), !0, d.spacingBox), u(o) || (d = t.getBBox(), j[j.translateX < d.x + d.width + 10 ? "hide" : "show"]()), c.setInputValue("min", a), c.setInputValue("max", b));
            c.rendered = !0
        },
        destroy: function () {
            var a =
                this.minInput, b = this.maxInput, c = this.chart, d = this.blurInputs, e;
    ...
    R(J.prototype, "getPlotLinePath", function (a, b, c, d, e, f) {
        ...
        w = g.isXAxis ? u(g.options.yAxis) ? [i.yAxis[g.options.yAxis]] : Aa(h, function (a) {
            return a.yAxis
        }) : u(g.options.xAxis) ? [i.xAxis[g.options.xAxis]] : Aa(h, function (a) {
            return a.xAxis
        });
    ...
    R(J.prototype, "hideCrosshair", function (a, b) {
        ...
        this.crossLabelArray[b].hide() : n(this.crossLabelArray, function (a) {
            a.hide()
        }))
    });
    R(J.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (u(this.crosshair.label) && this.crosshair.label.enabled && u(c)) {
            ...
            if (l < k || l > k + this.height)this.hideCrosshair(); else {
                ...
                j.attr({
                    text: n ?
                        Ma(n, {value: c[g]}) : f.formatter.call(this, c[g]), x: m, y: l, visibility: "visible"
                });
                c = j.getBBox();
                if (b) {
    ...
    var oc = da.init, pc = da.processData,
    ...
    R(O.prototype, "render", function (a) {
        if (this.chart.options._stock)!this.clipBox && this.animate ? (this.clipBox = z(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (ab(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({
