...
//                echo "Enter in IF of meterFetchingSql";
        while ($rowForMeterId = $resultForMeterId->fetch_array(MYSQL_ASSOC)) {
            ...
            $currentDateTime_Less = date("Y-m-d H:i:s", strtotime($currentDateTime) - 4);
            $currentDateTime_More = date("Y-m-d H:i:s", strtotime($currentDateTime) + 4);
